...
export class MiFloraDevice extends Device {
    private id!: string;
     ...
     * @param value
     */
    updateCapabilityValue(capability: string, value: string) {
     ...
     * @param value
     */
    _checkThresholdTrigger(capability: string, value: string) {
     ...
     * @returns {Promise.<*>}
     */
    async getDeviceData(property: string): Promise<string|null> {
