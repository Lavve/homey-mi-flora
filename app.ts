...
import {App, Device, Driver, FlowCardAction, FlowCardTrigger, FlowCardTriggerDevice} from 'homey';
...
class HomeyMiFloraApp extends App {
    private devices!: Device[];
    private deviceSensorUpdated!: FlowCardTriggerDevice;
    private globalSensorUpdated!: FlowCardTrigger;
    private deviceSensorChanged!: FlowCardTriggerDevice;
    private globalSensorChanged!: FlowCardTrigger;
    private globalSensorTimeout!: FlowCardTrigger;
    private globalSensorThresholdMinExceeds!: FlowCardTrigger;
    private deviceSensorThresholdMinExceeds!: FlowCardTriggerDevice;
    private globalSensorThresholdMaxExceeds!: FlowCardTrigger;
    private deviceSensorThresholdMaxExceeds!: FlowCardTriggerDevice;
    private globalSensorOutsideThreshold!: FlowCardTrigger;
    private deviceSensorOutsideThreshold!: FlowCardTriggerDevice;
    private update!: FlowCardAction;

    private _capabilityOptions = [
        'measure_temperature',
        'measure_luminance',
        'measure_nutrition',
        'measure_moisture',
    ...
    unregisterDevice(device: Device) {
        this.devices = this.devices.filter(current => current.getAppId() !== device.getAppId());
    }
     ...
     */
    async handleUpdateSequence(device: Device) {
     ...
     */
    async updateDevices(devices: Device[]) {
        // console.log(' ');
        // console.log(' ');
        // console.log(' ');
        // console.log(' ');
     ...
     */
    async discoverDevices(driver: Driver) {
